...
public class ShoppingWithChosenListPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_shopping_with_chosen_list_page);

       int[] Nodes = new int[]{3, 2, 4, 24, 46, 67, 79};
...
class AlgorithmForShoppingInStore {
